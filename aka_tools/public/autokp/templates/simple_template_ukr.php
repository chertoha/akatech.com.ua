...
<div id=inner_pdf>  
    ...
    <div id="prod_pdf">
        ...
        $div_products_html .= '<th>Мал</th>';
        $div_products_html .= '<th>Артикул</th>';
        $div_products_html .= '<th>Опис</th>';
        $div_products_html .= '<th>К-ть</th>';
        $div_products_html .= '<th>Ціна, грн з ПДВ</th>';
        $div_products_html .= '<th>Сума, грн з ПДВ</th>';
        $div_products_html .= '<th>Термін постачання</th>';
        $div_products_html .= '</tr>';
...
//        $div_products_html .= '<hr>';
        ...
        <div class="total_sum">
            <h2> Всього: <?= number_format($data['common_data']['total_sum'], 2, ',', ' ') ?> грн з ПДВ</h2>
        </div>
